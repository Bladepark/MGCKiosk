...
abstract class AbstractMenu: GoBackOrEnd {
    ...
    // 스틱커피
    val originalAmericano = Triple("오리지날아메리카노" , 4.9, "")
    val decafAmericano = Triple("디카페인아메리카노" , 4.9, "")
    val steviaMixCoffee = Triple("스테비아믹스커피" , 5.9, "")
    val steviaDecafMixCoffee = Triple("스테비아디카페인믹스커피" , 5.9, "")
