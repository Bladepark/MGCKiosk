...
class CookieMacaron() : AbstractMenu() {
    override fun displayInfo() {
        ...
        when(menuNumber) {
            1 -> {selectMenuItem(this, CreamCheeseYakgwaCookie())}
            2 -> {selectMenuItem(this, MatchaSmoresCookie())}
            3 -> {selectMenuItem(this, MacadamiaCookie())}
            4 -> {selectMenuItem(this, ChocolateChipCookie())}
            5 -> {selectMenuItem(this, StrawberryYogurtMacaron())}
            6 -> {selectMenuItem(this, MegaChocolateMacaron())}
            7 -> {selectMenuItem(this, UnicornFrappeMacaron())}
            8 -> back(this)
        }
    }
}