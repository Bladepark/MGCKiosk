...
class Bread() : AbstractMenu() {
    override fun displayInfo() {
        ...
        when(menuNumber) {
            1 -> {selectMenuItem(this, PizzaBread())}
            2 -> {selectMenuItem(this, CornMayoBread())}
            3 -> {selectMenuItem(this, HoneyBread())}
            4 -> {selectMenuItem(this, SaltyButterRoll())}
            5 -> {selectMenuItem(this, Croissant())}
            6 -> {selectMenuItem(this, PotatoBread())}
            7 -> {selectMenuItem(this, Hotdog())}
            8 -> back(this)
        }
    }
}