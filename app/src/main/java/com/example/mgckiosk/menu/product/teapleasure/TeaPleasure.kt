...
class TeaPleasure() : AbstractMenu() {
    override fun displayInfo() {
        ...
        when(menuNumber) {
            1 -> {selectMenuItem(this, TeaPleasureBloomingChamomile())}//teaPleasureBloomingChamomile()
            2 -> {selectMenuItem(this, TeaPleasureFruityRooibos())}//teaPleasureFruityRooibos()
            3 -> {selectMenuItem(this, TeaPleasureSweetHibiscus())}//teaPleasureSweetHibiscus()
            4 -> back(this)
        }
    }
}